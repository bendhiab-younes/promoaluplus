...
@endphp
@section('title', __('messages.seo_title_about'))
@section('meta_description', __('messages.seo_desc_about'))
@section('og_title', __('messages.seo_title_about'))
@section('og_description', __('messages.seo_desc_about'))
            ...
            <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div class="scroll-fade">
                    <span class="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 inline-block me-1 -mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                ...
                <div class="scroll-fade stagger-1">
                    <img src="{{ $storyImage }}"
                         ...
                         class="w-full h-[320px] md:h-[420px] object-cover rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-500">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6 md:px-8 text-center">
            <div class="scroll-fade mb-10 md:mb-14">
                <span class="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 inline-block me-1 -mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>
